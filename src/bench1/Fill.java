...
public class Fill {
	...
	static void fill (Connection conni, PreparedStatement prepStmt, int n,
		...
		for(int i=0;i<n*100000;i++){
			...
			fw.write((i + 1) + "\tnameMit20Buchstaben!\t0\t" + randomArr[i] + "\tabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnop\n");
//			fw.append(System.getProperty("line.seperator")); // oder auch \n (Windows?)
